package com.example.mmyphone.data

import android.content.Context
import android.widget.Toast
import androidx.lifecycle.ViewModel
import androidx.navigation.NavController
import com.example.mmyphone.models.UserModel
import com.example.mmyphone.navigation.ROUTE_DASHBOARD
...
class AuthViewModel:ViewModel() {
    ...
    fun signup(username:String,
        ...
        if (username.isBlank() ||fullname.isBlank()|| email.isBlank() || password.isBlank() || confirmpassword.isBlank()) {
            Toast.makeText(context, "Password fill all the fields", Toast.LENGTH_LONG).show()
            return
